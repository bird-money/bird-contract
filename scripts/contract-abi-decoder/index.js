...
// console.log(abiDecoder.addABI(testABI));
// const testData = "0x00000000000000000000000000000000000000000000000000470de4df820000000000000000000000000000000000000000000000000000016345785d8a0000";
// const decodedData = abiDecoder.decodeMethod(testData);
// console.log("Data", decodedData);

const abi = require('web3-eth-abi');
let encode = "0x00000000000000000000000000000000000000000000000000470de4df820000000000000000000000000000000000000000000000000000016345785d8a0000";
let decodeParameter = abi.decodeParameter(['uint', 'uint'], encode);
